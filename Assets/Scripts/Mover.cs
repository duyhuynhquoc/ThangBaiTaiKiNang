...
public class Mover : MonoBehaviour
{
    ...
    [SerializeField]
    private float m_JumpSpeed = 10f; // Amount of force added when the player jumps.
    ...
    public void Move(float move, bool crouch, bool jump)
    {
        ...
        if (m_Grounded || m_AirControl)
        {
            ...
            Vector3 targetVelocity = new Vector2(
                move * m_MoveSpeed * 10f * Time.deltaTime,
            ...
            if (jump)
            {
                ...
                m_Grounded = false;
                targetVelocity = new Vector2(targetVelocity.x, m_JumpSpeed);
            }
